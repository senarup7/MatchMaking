...
public class Match3Bot : MonoBehaviour {
    ...
    private void Awake() {
        ...
        match3Visual.OnUserChanged += Match3Visual_OnUserChanged;
    ...
    private void Match3Visual_OnUserChanged(object sender, System.EventArgs e)
    {

        Debug.Log("State Changed"+ match3Visual.GetUserState());
        switch (match3Visual.GetUserState())
        {
    ...
    private Match3.PossibleMove GetBestPossibleMove(List<Match3.PossibleMove> possibleMoveList) {
        ...
        Debug.Log(">>>>> levelSO.goalType >>>>>>> " + levelSO.goalType);
